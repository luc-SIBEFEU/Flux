...
# AangaraaPay retiré — on utilise désormais directement les API officielles
# MTN MoMo et Orange Money. Tant que ces clés ne sont PAS renseignées, le site
# bascule automatiquement en mode paiement MANUEL (aucune erreur, aucun blocage).
