...
<div class="p-6 max-w-2xl">
    ...
    <div class="bg-white rounded-xl shadow border border-gray-100 p-6 mb-6">
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Hôtelier</p>
            </div>
        </div>

        <form method="POST" action="{{ route('hotelier.profile.update') }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            @method('PUT')
            <div>
    ...
    <div class="bg-white rounded-xl shadow border border-gray-100 p-6">
        ...
        <form method="POST" action="{{ route('hotelier.profile.password') }}" class="space-y-4">
            @csrf
            @method('PUT')
            <div>
