...
<div class="p-6 max-w-xl">
    ...
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Nouvelle actualité</h1>

    <form method="POST" action="{{ route('admin.actualites.store') }}" enctype="multipart/form-data" class="bg-white rounded-xl shadow border border-gray-100 p-6 space-y-4">
        @csrf
